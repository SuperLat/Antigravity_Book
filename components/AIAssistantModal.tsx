...
import { Sparkles, Book, User, Send, Wand2, ChevronDown, Cpu, X, Link, Maximize2, Minimize2, Layout } from 'lucide-react';
                    ...
                    <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-gray-950 custom-scrollbar">
                        ...
                        {chatHistory.map((msg) => (
                            <div key={msg.id} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                                <div className={`max-w-[85%] rounded-lg p-4 text-sm leading-relaxed whitespace-pre-wrap shadow-sm ${msg.role === 'user'
                        ...
                        {isGenerating && (
                            <div className="flex justify-start">
                                <div className="bg-gray-800 border border-gray-700 rounded-lg p-4 flex items-center space-x-2">
